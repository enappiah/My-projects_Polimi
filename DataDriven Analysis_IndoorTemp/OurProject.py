...
DF_DataSet = read_file("C:/Users/Akwesi/Desktop/Our_Project/DataDriven Analysis/dataset1.csv")
DF_DataSet.head()
...
#===============================================================================================================
DF_SelectedVariables=dataSet_Normalized[['Inside_Temp_sensor_1hr','Outside_Temp_sensor','Solar_irradiance_3hr','Wind_10hours']]

#Testing Our Model
target = DF_SelectedVariables['Inside_Temp_sensor_1hr']
features = DF_SelectedVariables[['Outside_Temp_sensor','Solar_irradiance_3hr','Wind_10hours']]
...
plot = sns.regplot(x='Inside_Temp_sensor_1hr', y="Predicted T_in_SVR_CV",
...
# Calculating the accuracy metrics of the implemented machine learning model
from sklearn.metrics import mean_absolute_error,mean_squared_error,r2_score
R2_score_DF_SVR_CV = r2_score(predict_DF_SVR_CV['Inside_Temp_sensor_1hr'],predict_DF_SVR_CV["Predicted T_in_SVR_CV"])
mean_absolute_error_SVR_CV = mean_absolute_error(predict_DF_SVR_CV["Inside_Temp_sensor_1hr"],predict_DF_SVR_CV["Predicted T_in_SVR_CV"])
mean_squared_error_SVR_CV = mean_squared_error(predict_DF_SVR_CV["Inside_Temp_sensor_1hr"],predict_DF_SVR_CV["Predicted T_in_SVR_CV"])
coeff_variation_SVR_CV = np.sqrt(mean_squared_error_SVR_CV)/predict_DF_SVR_CV["Inside_Temp_sensor_1hr"].mean()
...
fig = plt.figure()
ax1 = fig.add_subplot(111)
plot = sns.regplot(x='Inside_Temp_sensor_1hr', y='Predicted_T_in_RF_CV',
...
from sklearn.metrics import mean_absolute_error,mean_squared_error,r2_score
R2_score_DF_RF_CV = r2_score(predict_DF_RF_CV['Inside_Temp_sensor_1hr'],predict_DF_RF_CV['Predicted_T_in_RF_CV'])
mean_absolute_error_DF_CV =  mean_absolute_error(predict_DF_RF_CV['Inside_Temp_sensor_1hr'],predict_DF_RF_CV['Predicted_T_in_RF_CV'])
mean_squared_error_DF_CV = mean_squared_error(predict_DF_RF_CV['Inside_Temp_sensor_1hr'],predict_DF_RF_CV['Predicted_T_in_RF_CV'])
coeff_variation_DF_CV = np.sqrt(mean_squared_error_DF_CV)/predict_DF_RF_CV['Inside_Temp_sensor_1hr'].mean()
